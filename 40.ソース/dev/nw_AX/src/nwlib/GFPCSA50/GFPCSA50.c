    ...
    short           *matchinfo_len)
{
    ...
    *matchinfo_len = 0;
    ...
    if (memcmp(mtiinfo, DEF_AX_MTI_1804_REQ, strlen(DEF_AX_MTI_1804_REQ))==0) {
        if ((ffd_1804->b11_system_audit_number.ffd_header.m_flg_exist) &&
            ...
            memcpy(matchkey->mti, DEF_AX_MTI_1804_REQ, sizeof(matchkey->mti));
    ...
    if (memcmp(mtiinfo, DEF_AX_MTI_1814_RSP, strlen(DEF_AX_MTI_1814_RSP))==0) {
