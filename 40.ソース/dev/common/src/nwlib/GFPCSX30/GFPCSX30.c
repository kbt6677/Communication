...
/*   版  修正者     修正日     修正内容                                      */
/*  ==== ========== ========== ============================================= */
/*  1.0  T.Sugisaki 2025/06/10 (J0680)新規作成                               */
/*                                                                           */
/*****************************************************************************/
/****************************************************************************/
/*   ｺﾝﾊﾟｲﾙｵﾌﾟｼｮﾝ                                                           */
            ...
            , short              send_msg_type)
{
    ...
    msg_common->msg_data_len = msg_in->msg_in_len;
    memcpy(msg_common->msg_data ,msg_in->msg_in_addr ,msg_in->msg_in_len);
    msg_out->msg_out_len = msg_in->msg_in_len + sizeof(msg_common->msg_data_len);
    return;
}
/* end of NWM_HDE */
